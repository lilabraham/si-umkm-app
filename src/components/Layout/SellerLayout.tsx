// LOKASI FILE: src/components/layout/SellerLayout.tsx
        ...
        <aside className="w-64 bg-white border-r border-gray-200 p-5 hidden md:block">
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto pt-4 border-t border-gray-200">
                <Link href="/" className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900">
