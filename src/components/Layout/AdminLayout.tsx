...
import { LayoutDashboard, Users, ShoppingCart, BookOpen, LogOut, Home } from 'lucide-react';
...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const sidebarLinks = [
    ...
    { name: 'Manajemen Pelatihan', href: '/admin/pelatihan', icon: BookOpen },
  ];
        ...
        <aside className="w-64 bg-white border-r border-gray-200 p-5 hidden md:block">
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto pt-4 border-t border-gray-200">
                ...
                <Link href="/" className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100">
                    <Home size={18} /> Kembali ke Website
                </Link>
                <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-2.5 mt-2 rounded-lg text-sm font-medium text-red-600 hover:bg-red-100">
