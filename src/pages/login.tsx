...
const LoginPage = () => {
  ...
  return (
    <>
      {/* BG & Shell responsif yang konsisten */}
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 via-white to-blue-100">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-2xl shadow-xl overflow-hidden">
          {/* Panel kiri hanya tampil di lg+ (desktop) */}
          ...
          <div className="p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
            {/* Brand ringkas khusus mobile agar konsisten */}
            ...
            >
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    {/* FIX: salah ketik -> pakai -translate-y-1/2 */}
                    <Mail
                      size={18}
                    ...
                    <input
                      ...
                      autoComplete="email"
                      autoFocus
                      className="w-full border border-gray-300 rounded-md px-4 py-2.5 pl-10 text-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 pt-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-blue-600 text-white py-2.5 rounded-md font-semibold hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed flex justify-center items-center"
                  >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 bg-white text-gray-400">ATAU LANJUTKAN DENGAN</span>
                </div>
              </div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full flex justify-center items-center gap-3 py-2.5 border border-gray-300 rounded-md hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors"
              >
                <svg className="w-5 h-5" aria-hidden="true" viewBox="0 0 488 512">
                  <path
                    fill="currentColor"
                    d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 21.2 174 58.9l-65.2 65.2c-23.1-22.4-56.3-35.8-98.8-35.8-84.9 0-153.3 67.2-153.3 150s68.4 150 153.3 150c93.2 0 132.3-72.3 137-108.3H248v-85.3h236.1c2.3 12.7 3.9 26.9 3.9 41.4z"
                  ></path>
                </svg>
              ...
              <p className="mt-8 text-center text-sm text-gray-600">
                ...
                <Link href="/daftar-penjual" className="font-medium text-blue-600 hover:underline">
                </Link>
                .
              </p>
            </motion.div>
              ...
              <form onSubmit={handlePasswordReset}>
                ...
                <AnimatePresence>
                  {resetMessage && (
                    <motion.div
                      ...
                      style={{
                        backgroundColor:
                          resetMessage.type === 'success' ? '#ECFDF5' : '#FEF2F2',
                ...
                <div className="flex items-center justify-end gap-4 mt-6">
                  ...
                  <button
                    ...
                    className="bg-blue-600 text-white font-semibold py-2 px-5 rounded-md disabled:bg-gray-400 flex items-center"
                  >
